...
* **UI Prototype**: 8 views implemented (Network, Stack, Lago Grey, Ports, Security, Gaps, Simulation, Settings)
* **Backend**: Not implemented yet (Phoenix/GraphQL planned)
* **Validation Engine**: Not implemented yet (rules exist in tests, formal engines planned)
* **Persistence**: Local import/export hooks exist; durable storage not wired
* **Docs**: Some documents are aspirational; see `STATUS.md` for the source of truth
